...
public class ConfigBean {
    ...
    public void populateBD() {
        ...
        try {
            ...
            administratorBean.createAdmininstrator("a1", "a1", "Francisco Fernandes", "2131089@DAE.pt");
            administratorBean.createAdmininstrator("administrator1", "administrator1", "Gonçalo", "Admistrator1@DAE.pt");
            ...
            responsibleBean.createResponsible("r1", "r1", "Francisco Fernandes", "2131089@DAE.pt");
            ...
            participantBean.createParticipant("p1", "p1", "Francisco Fernandes", "2131089@DAE.pt");
            ...
            eventBean.createEvent(5, formatter.parse("07/10/2016"), "Evento 5", "Aula", "ESTG", "r1");
            eventBean.createEvent(6, formatter.parse("13/02/2016"), "Evento 6", "Aula", "IPL - ESTG", "r1");
            eventBean.createEvent(7, formatter.parse("07/11/2018"), "Evento 7", "Palestra", "ESTG", "r1");
            eventBean.createEvent(8, formatter.parse("18/02/2017"), "Evento 8", "Aula", "ESTG", "r1");
            ...
            participantBean.enrollParticipant("p1", 1);
            participantBean.enrollParticipant("p1", 4);
            participantBean.enrollParticipant("p1", 5);
